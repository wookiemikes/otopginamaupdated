            ...
            <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="#pablo">Admin Dashboard / Inventory Update</a>
                    </div>
                        ...
                        <div class="card ">
                            <div class="card-header ">
                                <h5 class="card-title">
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-10"><b>Update Item Inventory</b></div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body ">
                                <form action="dashboardinventory_update1.php" method="post">
                                    <div>
                                        <input class="form-control col-md-3" type="text" name="shelve_update" value="<?php echo $_SESSION["shelve_id"]; ?>" readonly>
                                    </div>
                                    <div>
                                        <label for=""><b>Product Name:</b></label>
                                        <input class="form-control col-md-12" type="text" name="product_update" value="<?php echo $_SESSION["product_name"]; ?>" readonly>
                                    </div>
                                    <br>
                                    <div>
                                        <label for=""><b>Quantity</b></label>
                                        <input class="form-control col-md-12" type="number" name="QTY_update" value="<?php echo $_SESSION["QTY"]; ?>">
                                    </div>
                                    <br>
                                    <div class="text-center">
                                        <input class="btn btn-md btn-warning col-md-6" type="submit" name="updateinventory" value="UPDATE INVENTORY">
                                    </div>
                                </form>
