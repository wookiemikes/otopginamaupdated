            ...
            <div class="card ">
              <div class="card-header ">
                <h5 class="card-title">
                  <div class="col-md-12">
                    <div class="row">
                      <div class="col-md-10"><b>Product Inventory</b></div>
                      <div class="col-md-2">
                        <button class="btn btn-sm btn-success" data-toggle="modal" data-target="#addproduct" href="#" style="float:right;">
                          <div class="icon-big text-center icon-warning">
              ...
              <div class="card-body ">
                <div class="table-responsive">
                  <table class="table table-bordered" id="inventory_table" width="100%" cellspacing="0">
  ...
  <div class="modal fade bd-example-modal-lg" id="addproduct" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <form method="post" action="dashboardinverntory1.php">
          <div class="modal-body">
            <div class="container-fluid row">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  <label for="message-text" class="col-form-label"><b>Quantity</b></label>
                  <input class="form-control" placeholder="Enter Number" type="text" name="QTY" id="QTY">
                </div>
              </div>
            </div>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">No, Nevermind</button>
            <button type="button" id="add" name="add" class="btn btn-primary">Yes, Continue</button>
          </div>
        </form>
      </div>
    </div>
